...
class inspectionWindow_20max(QDialog):
    ...
    def make(self):
        ...
        self.controlTab = QVBoxLayout()
        self.controlTab.addWidget(self.group2)
        self.controlTab.addWidget(self.group1)
        self.layout = QHBoxLayout(self)
        self.layout.addLayout(self.controlTab)
        self.layout.addLayout(self.imageLayout)
        self.setLayout(self.layout)
        self.setWindowTitle("Inspection Window")
    ...
    def setImageLayoutButtonIcons(self):
        ...
        for i in range(self.n_shown):
            ...
            self.imageLayoutButtons[i].setToolButtonStyle(Qt.ToolButtonTextUnderIcon)
            self.imageLayoutButtons[i].setIcon(QIcon(pixmap))
            self.imageLayoutButtons[i].setIconSize(pixmap.rect().size())
