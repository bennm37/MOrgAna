...
class morganaApp(QWidget):
    ...
    def createModelGroup(self):
        ...
        self.modelFolderSpace = QLineEdit()
        ...
        self.sigmasSpace = QLineEdit()
        self.sigmasSpace.setText("-")
        self.sigmasSpace.setEnabled(False)
        self.down_shapeLabel = QLabel("Downscaling:")
        self.down_shapeSpace = QDoubleSpinBox()
        self.down_shapeSpace.setSpecialValueText("-")
        self.down_shapeSpace.setMinimum(-1)
        self.down_shapeSpace.setMaximum(1)
        self.down_shapeSpace.setSingleStep(0.01)
        self.down_shapeSpace.setEnabled(False)
        self.edge_sizeLabel = QLabel("Edge size:")
        self.edge_sizeSpace = QSpinBox()
        self.edge_sizeSpace.setSpecialValueText("-")
        self.edge_sizeSpace.setMinimum(0)
        self.edge_sizeSpace.setEnabled(False)
        self.fractionLabel = QLabel("Pixel% extraction:")
        self.fractionSpace = QDoubleSpinBox()
        self.fractionSpace.setSpecialValueText("-")
        self.fractionSpace.setMinimum(0)
        self.fractionSpace.setMaximum(1)
        self.fractionSpace.setSingleStep(0.1)
        self.fractionSpace.setEnabled(False)
        self.biasLabel = QLabel("Extraction bias:")
        self.biasSpace = QDoubleSpinBox()
        self.biasSpace.setSpecialValueText("-")
        self.biasSpace.setMinimum(0)
        self.biasSpace.setMaximum(1)
        self.biasSpace.setSingleStep(0.1)
        ...
        self.imageFolderSpace = QLineEdit()
    ...
    def selectImageFolder(self):
        self.imageFolder = QFileDialog.getExistingDirectory(
            self,
            "Select Input Folder of Model",
            "C:\\Users\\nicol\\Desktop\\dmso",
        )
        if self.imageFolder == "":
            self.imageFolder = "-"
    ...
    def selectMaskFolder(self):
        self.maskFolder = QFileDialog.getExistingDirectory(
            self,
            "Select Input Folder of Masks",
            "C:\\Users\\nicol\\Desktop\\dmso",
        )
        if self.maskFolder == "":
    ...
    def createImportGroup(self):
        ...
        self.maskFolderSpace = QLineEdit()
        self.maskFolderSpace.setText(self.maskFolder)
        ...
        self.maskSpace = QLineEdit()
        self.maskSpace.setText("")
    ...
    def selectImportImageFolder(self):
        self.imageImportFolder = QFileDialog.getExistingDirectory(
            self,
            "Select Input Folder of Model",
            "C:\\Users\\nicol\\Desktop\\dmso",
        )
    ...
    def importImageMask(self):
        objectsparser.parsing_images(
            self.imageImportFolder,
            self.maskFolder,
            self.maskSpace.text(),
            self.isBorder.isChecked(),
        )
    ...
    def createFluoGraph(self):
        ...
        if not data_all:
            QMessageBox.warning(
                ...
                "The channel selected doesn't appear in the raw data!",
            )
            return
