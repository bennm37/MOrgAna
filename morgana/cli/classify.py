...
def predict_folder(image_folder_nested, classifier, scaler, params):
    ...
    if len(tifs) > 0:
        ...
        predict_batch(image_folder_nested, classifier, scaler, params)
    for folder in flist:
        folder_path = os.path.join(image_folder_nested, folder)
        if os.path.isdir(folder_path):
            predict_folder(folder_path, classifier, scaler, params)
